...
{
    internal static class UiGameSquareFactory
    {
        ...
        private static UiGameSquareBase CreateDrawableSquare(DtoConsoleGameSquare square)
        {
            ...
            return new UiGameSquare(charPoints.ToList(), pawnCoords.ToList(), square.Pawns,
        ...
        private static UiGameSquareBase CreateDrawableTeamBase(int boardWidth, int boardHeight, DtoConsoleGameSquare square)
        {
            ...
            var pawnCoords = FindCharXY(charPoints, 'X');
            charPoints = ReplaceCharPoints(charPoints, 'X', ' ');
            return new UiGameSquareTeam(charPoints.ToList(), pawnCoords.ToList(), square.Pawns,
                UiColor.TranslateColor(square.Color));
        }

        private static (int x, int y) GetBoardMaxPoint(IEnumerable<UiGameSquareBase> drawableSquares)
        {
