...
namespace LudoEngine.Board.Classes
{
    public static class Board
    {
        ...
        public static void Init()
        {
            ...
            boardSquares.AddRange(CreateStandardSquares((6,6), (6,1), BoardDirection.Up));
            ...
            boardSquares.AddRange(CreateStandardSquares((8,6), (13,6), BoardDirection.Down));
            ...
            boardSquares.AddRange(CreateSafeZoneSquares((8,5), (13,7), BoardDirection.Left));
        ...
        public static List<IGameSquare> TeamSquares(TeamColor color)
        {
            Type GoalType = null;
