...
namespace LudoEngine.BoardUnits.Main
{
    ...
    {
        public static List<Pawn> PawnsInBase(List<IGameSquare> boardSquares, TeamColorCore color) =>
        ...
        public static List<Pawn> OutOfBasePawns(List<IGameSquare> boardSquares, TeamColorCore color) => AllPlayingPawns(boardSquares).FindAll(x => x.Color == color);
        ...
        public static List<Pawn> GetTeamPawns(List<IGameSquare> boardSquares, TeamColorCore color) => boardSquares.SelectMany(x => x.Pawns).Where(x => x.Color == color).ToList();
    }
}